                                    ...
                                    <section class="u-align-center u-clearfix u-image u-shading u-section-1" src="" id="sec-95ca" data-image-width="626" data-image-height="417">
                                           ...
                                           <h1>Aliados</h1>
                                            <div class="u-form-group " align="left">
                                                <a href="Controlador?accion=AgregarAli"class="btn btn-success" ><span class="fa fa-undo" >Agregar Aliado</span></a>
                                            </div>
                                            ...
                                            <<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                ...
                                                <%
                                                    ...
                                                    List<Aliado> list = dao.listar();
                                                    Iterator<Aliado> iter = list.iterator();
                                                    Aliado per = null;
                                                    while (iter.hasNext()) {
                                                        per = iter.next();
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><%= per.getNom()%></td>
                                                        <td>
                                                            <a href="Controlador?accion=editarAliado&id=<%= per.getId()%>">Edit </a>
                                                            <a href="Controlador?accion=eliminarAliado&id=<%= per.getId()%>">Remove</a>
                                                        </td>
                                                    </tr>
                                                    <%}%>
                                                </tbody>
