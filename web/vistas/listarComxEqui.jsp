                            ...
                            <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-3">
                                ...
                                <li class="u-nav-item"><a class="u-button-style u-nav-link"  href="Controlador?accion=listarPatrocinador" style="padding: 10px 28px;">Patrocinador</a>
                                    ...
                                    <section class="u-align-center u-clearfix u-image u-shading u-section-1" src="" id="sec-95ca" data-image-width="626" data-image-height="417">
                                        ...
                                        <h1>Compañero por Equipo</h1>
                                        <div class="u-form-group " align="left">
                                            <a href="Controlador?accion=AgregarCompaneroxEquipo"class="btn btn-success" ><span class="fa fa-undo" >Agregar compañerpxEquipo</span></a>
                                        </div>
                                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <%
                                                ...
                                                List<CompaneroxEquipo> list = dao.listar();
                                                Iterator<CompaneroxEquipo> iter = list.iterator();
                                                CompaneroxEquipo per = null;
                                                while (iter.hasNext()) {
                                                    per = iter.next();
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><%= per.getId()%></td>
                                                    <td><%= per.getCompanero()%></td>
                                                    <td><%= per.getEquipo()%></td>
                                                    <td>
                                                        <a href="Controlador?accion=editarCompaneroxEquipo&id=<%= per.getId()%>">Edit </a>
                                                        <a href="Controlador?accion=eliminarCompaneroxEquipo&id=<%= per.getId()%>">Remove</a>
                                                    </td>
                                                </tr>
                                                <%}%>
                                            </tbody>
