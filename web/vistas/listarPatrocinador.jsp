                                ...
                                <li class="u-nav-item"><a class="u-button-style u-nav-link"  href="Controlador?accion=listarPatrocinador" style="padding: 10px 28px;">Patrocinador</a>
                                    ...
                                    <section class="u-align-center u-clearfix u-image u-shading u-section-1" src="" id="sec-95ca" data-image-width="626" data-image-height="417">
                                        ...
                                        <div class="u-form-group " align="left">
                                            <a href="Controlador?accion=AgregarPatro" class="btn btn-success" ><span class="fa fa-undo" >Agregar Patrocinador</span></a>
                                        </div>
                                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <%
                                                ...
                                                List<Patrocinador> list = dao.listar();
                                                Iterator<Patrocinador> iter = list.iterator();
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><%= patro.getNom()%></td>
                                                    <td>
                                                        <a href="Controlador?accion=editarPatrocinador&id=<%= patro.getId()%>">Edit </a>
                                                        <a href="Controlador?accion=eliminarPatrocinador&id=<%= patro.getId()%>">Remove</a>
                                                    </td>
                                                </tr>
                                                <%}%>
                                            </tbody>
